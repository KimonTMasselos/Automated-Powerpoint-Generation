...
select segments.name as segment, abi.basket_id, abi.product_id,  
    ...
    case when abi.product_id in (select * from segment_products) then TRUE else FALSE end as category_product
from basketss
