...
for (i in 1:length(eram_categories)) {
  ...
  # dt[[3]][4] <- 'Εντομοαπωθητικά ΑντικουνουπικάΕντομοαπωθητικά ΑντικουνουπικάΕντομοαπωθητικά Αντικουνουπικά'
  ...
  data %>% 
    ...
    gtsave(filename = "../output/company_category_penetration.png", vwidth = 2000, zoom = 2)
  ...
  data %>% 
    ...
    gtsave(filename = "../output/total_category_penetration.png", vwidth = 2000, zoom = 2)
